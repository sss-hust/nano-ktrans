...
status: M-18 closed (routing-aware GPU residency: empirically-hottest-92 replaces uniform first-92 via offline calibration; decode TPS 0.7456 -> 0.9572 at offload=92, +28.4%, single-milestone historical max, breaks 0.9 TPS); pim main line at M-18 (decode TPS 0.9572 at offload=92, cumulative since M-15 +49.5%, vs CPU 3.21x); M-19 active (combine M-18 with offload=88/84 envelope to test if hottest-N can safely lower memory pressure further)
created: 2026-04-22
updated: 2026-04-29
