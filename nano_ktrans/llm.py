...
class LLM:
    ...
    def reset_offload_diagnostics(self) -> None:
        ...
        if runtime is not None:
            ...
            runtime.background_apply_commit_queue_enqueued_total = 0
            runtime.background_apply_commit_batch_queue_enqueued_total = 0
            runtime.background_apply_commit_batch_queue_prefinalized_total = 0
            runtime.background_resident_commit_batch_queue_enqueued_total = 0
            runtime.background_resident_commit_batch_queue_prefinalized_total = 0
            ...
            runtime.background_resident_commit_finalize_ready_queue_enqueued_total = 0
        ...
        for layer in self.model.model.layers:
            ...
            hybrid_moe.apply_commit_batch_queue_batches = 0
            hybrid_moe.apply_commit_batch_queue_committed_batches = 0
            hybrid_moe.apply_commit_batch_queue_pruned = 0
            hybrid_moe.background_apply_commit_batch_queue_enqueued = 0
            hybrid_moe.background_apply_commit_batch_queue_committed_batches = 0
            hybrid_moe.background_apply_commit_batch_queue_prefinalized_batches = 0
            hybrid_moe.resident_commit_batch_queue_enqueued = 0
            hybrid_moe.resident_commit_batch_queue_batches = 0
            hybrid_moe.resident_commit_batch_queue_committed_batches = 0
            hybrid_moe.resident_commit_batch_queue_pruned = 0
            hybrid_moe.resident_commit_batch_queue_evictions = 0
            hybrid_moe.background_resident_commit_batch_queue_enqueued = 0
            hybrid_moe.background_resident_commit_batch_queue_committed_batches = 0
            hybrid_moe.background_resident_commit_batch_queue_prefinalized_batches = 0
            hybrid_moe.resident_commit_finalize_queue_enqueued = 0
            hybrid_moe.resident_commit_finalize_queue_batches = 0
            hybrid_moe.resident_commit_finalize_queue_committed_batches = 0
            hybrid_moe.resident_commit_finalize_queue_pruned = 0
            hybrid_moe.resident_commit_finalize_queue_evictions = 0
            hybrid_moe.background_resident_commit_finalize_queue_enqueued = 0
            hybrid_moe.background_resident_commit_finalize_queue_committed_batches = 0
            hybrid_moe.background_resident_commit_finalize_queue_prefinalized_batches = 0
            hybrid_moe.resident_commit_ready_cache_stores = 0
            hybrid_moe.resident_commit_ready_cache_hits = 0
            ...
            hybrid_moe.resident_commit_finalize_ready_queue_enqueued = 0
            hybrid_moe.resident_commit_finalize_ready_queue_batches = 0
            hybrid_moe.resident_commit_finalize_ready_queue_committed_batches = 0
            hybrid_moe.resident_commit_finalize_ready_queue_pruned = 0
            hybrid_moe.resident_commit_finalize_ready_queue_evictions = 0
            hybrid_moe.background_resident_commit_finalize_ready_queue_enqueued = 0
            hybrid_moe.background_resident_commit_finalize_ready_queue_committed_batches = 0
            hybrid_moe.background_resident_commit_finalize_ready_queue_prefinalized_batches = 0
