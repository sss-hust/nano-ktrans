...
PROFILE_SWEEP_METRIC_DIRECTIONS = {
    ...
    "prepared_cache_budget_backoff_avg": "min",
...
def summarize_offload_diagnostics(offload_diagnostics: dict[str, Any]) -> dict[str, Any]:
    ...
    summary = {
        ...
        "prepared_controller_aggressiveness": offload_diagnostics.get("prepared_controller_aggressiveness"),
        ...
        "offload_background_apply_commit_batch_queue_prefinalized_total": int(
            (offload_diagnostics.get("offload_refresh") or {}).get(
                "offload_background_apply_commit_batch_queue_prefinalized_total", 0
            )
        ),
        "offload_background_resident_commit_batch_queue_enqueued_total": int(
            (offload_diagnostics.get("offload_refresh") or {}).get(
                "offload_background_resident_commit_batch_queue_enqueued_total", 0
            )
        ),
        ...
        "offload_background_resident_commit_ready_cache_stores_total": int(
            (offload_diagnostics.get("offload_refresh") or {}).get(
                "offload_background_resident_commit_ready_cache_stores_total", 0
            )
        ),
        ...
        "prefetch_background_ready_callbacks": 0,
        "pipeline_ticks": 0,
        ...
        "resident_commit_ready_cache_size": 0,
        "resident_commit_ready_cache_limit": 0,
        "resident_commit_ready_cache_utilization": 0.0,
        ...
        "apply_commit_batch_queue_batches": 0,
        "apply_commit_batch_queue_committed_batches": 0,
        "apply_commit_batch_queue_pruned": 0,
        "apply_commit_batch_queue_evictions": 0,
        "resident_commit_batch_queue_enqueued": 0,
        "resident_commit_batch_queue_batches": 0,
        ...
        "resident_commit_apply_queue_batches": 0,
        ...
        "apply_commit_queue_pressure": 0.0,
        ...
        "background_apply_commit_batch_queue_committed_batches": 0,
        "background_apply_commit_batch_queue_prefinalized_batches": 0,
        ...
        "quantized_down_preload_overlap": 0,
    ...
    for layer in layers:
        ...
        summary["prefetch_background_ready_callbacks"] += int(
            (layer.get("materialization_manager") or {}).get("prefetch_background_ready_callbacks", 0)
        )
        ...
        summary["resident_commit_batch_queue_size"] += int(
            layer.get("resident_commit_batch_queue_size", 0)
        )
        summary["resident_commit_batch_queue_limit"] += int(
            layer.get("resident_commit_batch_queue_limit", 0)
        )
        ...
        summary["resident_commit_ready_cache_size"] += int(
            layer.get("resident_commit_ready_cache_size", 0)
        )
        summary["resident_commit_ready_cache_limit"] += int(
            layer.get("resident_commit_ready_cache_limit", 0)
        )
        summary["resident_commit_ready_cache_utilization"] += float(
            layer.get("resident_commit_ready_cache_utilization", 0.0)
        )
        summary["resident_commit_apply_queue_size"] += int(
            layer.get("resident_commit_apply_queue_size", 0)
        )
        summary["resident_commit_apply_queue_limit"] += int(
            layer.get("resident_commit_apply_queue_limit", 0)
        )
        ...
        summary["apply_commit_batch_queue_batches"] += int(
            layer.get("apply_commit_batch_queue_batches", 0)
        )
        summary["apply_commit_batch_queue_committed_batches"] += int(
            layer.get("apply_commit_batch_queue_committed_batches", 0)
        )
        ...
        summary["resident_commit_batch_queue_enqueued"] += int(
            layer.get("resident_commit_batch_queue_enqueued", 0)
        )
        summary["resident_commit_batch_queue_batches"] += int(
            layer.get("resident_commit_batch_queue_batches", 0)
        )
        summary["resident_commit_batch_queue_committed_batches"] += int(
            layer.get("resident_commit_batch_queue_committed_batches", 0)
        )
        summary["resident_commit_batch_queue_pruned"] += int(
            layer.get("resident_commit_batch_queue_pruned", 0)
        )
        ...
        summary["resident_commit_ready_cache_stores"] += int(
            layer.get("resident_commit_ready_cache_stores", 0)
        )
        summary["resident_commit_ready_cache_hits"] += int(
            layer.get("resident_commit_ready_cache_hits", 0)
        )
        summary["resident_commit_ready_cache_pruned"] += int(
            layer.get("resident_commit_ready_cache_pruned", 0)
        )
        summary["resident_commit_ready_cache_evictions"] += int(
            layer.get("resident_commit_ready_cache_evictions", 0)
        )
        summary["resident_commit_apply_queue_enqueued"] += int(
            layer.get("resident_commit_apply_queue_enqueued", 0)
        )
        summary["resident_commit_apply_queue_batches"] += int(
            layer.get("resident_commit_apply_queue_batches", 0)
        )
        summary["resident_commit_apply_queue_committed_batches"] += int(
            layer.get("resident_commit_apply_queue_committed_batches", 0)
        )
        summary["resident_commit_apply_queue_pruned"] += int(
            layer.get("resident_commit_apply_queue_pruned", 0)
        )
        ...
        summary["apply_commit_queue_pressure"] += float(layer.get("apply_commit_queue_pressure", 0.0))
        ...
        summary["background_apply_commit_batch_queue_committed_batches"] += int(
            layer.get("background_apply_commit_batch_queue_committed_batches", 0)
        )
        summary["background_apply_commit_batch_queue_prefinalized_batches"] += int(
            layer.get("background_apply_commit_batch_queue_prefinalized_batches", 0)
        )
        summary["background_resident_commit_batch_queue_enqueued"] += int(
            layer.get("background_resident_commit_batch_queue_enqueued", 0)
        )
        summary["background_resident_commit_batch_queue_committed_batches"] += int(
            layer.get("background_resident_commit_batch_queue_committed_batches", 0)
        )
        ...
        summary["background_resident_commit_ready_cache_stores"] += int(
            layer.get("background_resident_commit_ready_cache_stores", 0)
        )
        summary["background_resident_commit_apply_queue_enqueued"] += int(
            layer.get("background_resident_commit_apply_queue_enqueued", 0)
        )
        ...
        summary["prepared_cache_budget_backoff"] += int(layer.get("prepared_cache_budget_backoff", 0))
        ...
        summary["prepared_cache_rebalance_pressure_step"] += float(
            layer.get("prepared_cache_rebalance_pressure_step", 0.0)
        )
        summary["prepared_cache_rebalance_pressure_ema"] += float(
            layer.get("prepared_cache_rebalance_pressure_ema", 0.0)
        )
        ...
        summary["quantized_down_preload_overlap"] += int(
            backend.get("quantized_down_preload_overlap_local", 0) or 0
        )
    ...
    if summary["resident_commit_batch_queue_limit"] > 0:
        summary["resident_commit_batch_queue_utilization"] = (
            summary["resident_commit_batch_queue_size"] / summary["resident_commit_batch_queue_limit"]
        )
    else:
    ...
    if summary["resident_commit_ready_cache_limit"] > 0:
        summary["resident_commit_ready_cache_utilization"] = (
            summary["resident_commit_ready_cache_size"] / summary["resident_commit_ready_cache_limit"]
        )
    else:
        summary["resident_commit_ready_cache_utilization"] = None
    if summary["resident_commit_apply_queue_limit"] > 0:
        summary["resident_commit_apply_queue_utilization"] = (
            summary["resident_commit_apply_queue_size"] / summary["resident_commit_apply_queue_limit"]
        )
    else:
    ...
    if summary["layer_count"] > 0:
        ...
        summary["prepared_cache_budget_backoff_avg"] = (
            summary["prepared_cache_budget_backoff"] / summary["layer_count"]
        )
        ...
        summary["prepared_cache_rebalance_pressure_step_avg"] = (
            summary["prepared_cache_rebalance_pressure_step"] / summary["layer_count"]
        )
        summary["prepared_cache_rebalance_pressure_ema_avg"] = (
            summary["prepared_cache_rebalance_pressure_ema"] / summary["layer_count"]
        )
        ...
        summary["apply_commit_queue_pressure_avg"] = (
            summary["apply_commit_queue_pressure"] / summary["layer_count"]
        )
        summary["apply_commit_queue_pressure_step_avg"] = (
            summary["apply_commit_queue_pressure_step"] / summary["layer_count"]
        )
        summary["apply_commit_queue_pressure_ema_avg"] = (
            summary["apply_commit_queue_pressure_ema"] / summary["layer_count"]
        )
        ...
        summary["prepared_cache_rebalance_pressure_step_avg"] = None
        ...
        summary["apply_commit_queue_pressure_avg"] = None
...
def summarize_profile_sweep_results(results: list[dict[str, Any]]) -> dict[str, Any]:
    ...
    for result in results:
        ...
        item = {
            ...
            "apply_commit_queue_pressure_avg": scheduler_summary.get("apply_commit_queue_pressure_avg"),
            "apply_commit_queue_pressure_step_avg": scheduler_summary.get("apply_commit_queue_pressure_step_avg"),
            ...
            "prepared_cache_budget_backoff_avg": scheduler_summary.get(
                "prepared_cache_budget_backoff_avg"
            ),
            ...
            "prepared_cache_rebalance_pressure_step_avg": scheduler_summary.get(
                "prepared_cache_rebalance_pressure_step_avg"
            ),
            "prepared_cache_rebalance_pressure_ema_avg": scheduler_summary.get(
                "prepared_cache_rebalance_pressure_ema_avg"
            ),
            ...
            "resident_commit_ready_cache_utilization": scheduler_summary.get(
                "resident_commit_ready_cache_utilization"
            ),
            "offload_background_resident_commit_batch_queue_enqueued_total": int(
            ...
            "offload_background_resident_commit_ready_cache_stores_total": int(
                scheduler_summary.get("offload_background_resident_commit_ready_cache_stores_total", 0)
            ),
